...
(S,F,opt,trues)=ptpath_test.load_grph_harm_sines_rp("/tmp/hsrp_20160504T161736928.mat")
...
d1=ptpath.g_f_2lp(D,F,10,ptpath_test.LPNode_rp_dist,{"calc_mean":0,"min_mean_dev":0})
print 'Calculating d2'
d2=ptpath.g_f_2lp(D,F,10,ptpath_test.LPNode_rp_eu_dist,{"calc_mean":0,"min_mean_dev":0})
print 'Solving d1'
sol1=ptpath_test.sol_test_1(d1)
print 'Solving d2'
sol2=ptpath_test.sol_test_1(d2)
ptpath_test.plot_lp_hsrp_cmp(sol1,sol2,D,trues)
